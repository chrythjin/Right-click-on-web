...
| 5 | 카테고리/설정값 결정 및 manifest/origin 정리 | ✅ 카테고리=Productivity, 출시 버전=0.6.3 확정 |
| 6 | ZIP 패키지 생성 및 최종 검증 | ✅ `right-click-on-web-v0.6.3.zip` 생성·검증 완료 |
...
- [x] 개인정보처리방침 URL 확보됨
- [x] 스토어 설명 작성됨
- [x] ZIP 패키지 생성됨 (`right-click-on-web-v0.6.3.zip`)
